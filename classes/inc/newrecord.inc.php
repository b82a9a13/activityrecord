...
if($errorarray != []){
    ...
    $result = $lib->create_activity_record([
        $apprentice,
        $reviewdate,
        $standard,
        $eors,
    ...
    if($result){
        ...
        \local_activityrecord\event\created_activity_record::create(array('context' => \context_course::instance($_SESSION['ar_records_cid']), 'courseid' => $_SESSION['ar_records_cid'], 'relateduserid' => $_SESSION['ar_records_uid']))->trigger();
    } else {
